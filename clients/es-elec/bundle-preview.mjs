...
const SITE = {
  title: 'ES Elec — temp preview',
  brand: 'ES Elec',
  note: 'Demo data marked TEMP swaps before go-live. Form runs in email mode.',
  bar: { ground: '#16130f', surface: '#211d17', edge: '#2d2820', ink: '#f4efe6', soft: '#b5aa97', accent: '#ffb24d', onAccent: '#171001' },
};
const ROUTES = [
