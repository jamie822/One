...
const shell = `<title>ES Elec — temp preview</title>
<style>
  :root {
    --ground: #16130f; --surface: #211d17; --edge: #2d2820;
    --ink: #f4efe6; --ink-soft: #b5aa97; --accent: #ffb24d;
  }
  ...
  nav button[aria-current="true"] { color: #171001; background: var(--accent); }
  nav button:focus-visible { outline: 2px solid var(--accent); outline-offset: 2px; }
  iframe { flex: 1; width: 100%; border: 0; background: #16130f; }
  .note { color: var(--ink-soft); font-size: 12px; width: 100%; }
  @media (min-width: 900px) { .note { width: auto; } }
</style>
<header>
  <span class="brand">ES Elec<small>temp preview · Stacked Out</small></span>
  <nav id="tabs" aria-label="Preview pages"></nav>
  <span class="note">Demo data marked TEMP swaps before go-live. Form runs in email mode.</span>
</header>
<iframe id="frame" title="ES Elec site preview"></iframe>
<script>
