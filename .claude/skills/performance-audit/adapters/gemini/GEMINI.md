...
This file is auto-loaded into Gemini's hierarchical memory. Verify with `/memory show`. Reload via `/memory refresh`.

You can also import additional files: `@references/lighthouse-issue-catalog.md`.
