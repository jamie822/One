...
- This file is treated as cacheable, read-only context — minimizes token cost
- Use `aider --read CONVENTIONS.md` for one-off sessions, or `.aider.conf.yml` for permanent
